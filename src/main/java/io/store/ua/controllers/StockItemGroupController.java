...
public class StockItemGroupController {
    ...
    @GetMapping("/findBy")
    public ResponseEntity<?> findBy(@RequestParam(name = "code", required = false) String code,
    ...
    @PostMapping
    public ResponseEntity<?> save(@RequestBody StockItemGroupDTO stockItemGroupDTO) {
        return ResponseEntity.ok(stockItemGroupService.save(stockItemGroupDTO));
    }

    @PutMapping
    public ResponseEntity<?> update(@RequestParam(name = "groupId") Long groupId,
